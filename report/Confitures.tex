...
\'Etant donn\'e que les suites $b(s)$ et $c(s)$ sont croissantes (c.f.\ annexe \hyperref[appendix:suites]{\textcolor{red}{A}}), les in\'egalit\'es (1) et (2) deviennent respectivement
\begin{alignat*}{1}
