...
\begin{figure}[!h]
  ...
  \begin{tikzpicture}
	\begin{axis}[%
	  ...
	  xmin=2,
	  xmax=30,
	  xlabel={Longueur du syst\`eme de capacit\'es ($k$)},
	  ylabel={Temps d'ex\'ecution (en s)},
	  legend entries={$S=30$,$S=40$,$S=50$},
 ...
 \begin{figure}[!h]
  ...
  \begin{tikzpicture}
	\begin{axis}[%
	  ...
	  scaled x ticks = true]
	  \addplot [color=blue,solid,line width=1.0pt] table[col sep=space] 
	  {../data/dp_d3_S5000.txt};
	  \addplot [color=red,solid,line width=1.0pt] table[col sep=space] 
	  {../data/dp_d3_S20000.txt};
	  \addplot [color=black,solid,line width=1.0pt] table[col sep=space]
      {../data/dp_d3_S80000.txt};
	\end{axis}
  \end{tikzpicture}
 ...
 \begin{figure}[!h]
  ...
  \begin{tikzpicture}
	\begin{axis}[%
	  ...
	  scaled x ticks = true]
	  \addplot [color=blue,solid,line width=1.0pt] table[col sep=space] 
	  {../data/ga_d2_S400000000.txt};
	  \addplot [color=red,solid,line width=1.0pt] table[col sep=space] 
	  {../data/ga_d2_S4000000000.txt};
	  \addplot [color=black,solid,line width=1.0pt] table[col sep=space]
      {../data/ga_d2_S40000000000.txt};
	\end{axis}
  \end{tikzpicture}
